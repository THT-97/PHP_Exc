<html>
    ...
    <body>
        <?php
            ...
            $query = "SELECT Hinh, Ten_Sua, Trong_luong, Don_gia FROM sua LIMIT $offset, $rowsPerPage";
            ...
            if($length<>0){
                ...
                while($arr = mysqli_fetch_array($result)){
                    echo "<td align='center'><p><b>$arr[Ten_Sua]</b><br/>"
                            ."$arr[Trong_luong] - $arr[Don_gia] VNĐ</p>"
